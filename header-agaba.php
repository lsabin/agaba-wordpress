...
<head profile="http://gmpg.org/xfn/11">
    ...
    <link rel="stylesheet" type="text/css" media="all" href="<?php bloginfo( 'template_url' ); ?>/css/jquery.ad-gallery.css" />
                ...
                <ul class="sf-menu" id="menu-nav">
                    ...
                    <li class=""><a href="">COCTELES</a>
                      <ul>
                        ...
                        <li><a href="<?php echo home_url( '/' ); ?>category/vuestros">Vuestras recetas</a></li>
